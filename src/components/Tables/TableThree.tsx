import { PersonnePhysique } from "@/types/personne-physique";
import SearchForm from "../Header/SearchForm";

const personnesPhysiquesData: PersonnePhysique[] = [
  {
    nom: "Hosny",
    prenom: "Raissi",
    dateNaissance: "12/12/1990",
    lieuNaissance: "Ariana",
    nationalite: "American",
    adresse: "Ariana",
    telephone: "1234567890",
    email: "hosny.raissi@gmail.com",
    profession: "Software Engineer",
    situationFamiliale: "Single",
    numeroPieceIdentite: "1234567890",
    typePieceIdentite: "CIN",
    dateDelivrancePieceIdentite: "12/12/2010",
    lieuDelivrancePieceIdentite: "Ariana",
    dateExpirationPieceIdentite: "12/12/2020",
    numeroPermisConduire: "1234567890",
    dateDelivrancePermisConduire: "12/12/2010",
    lieuDelivrancePermisConduire: "Ariana",
    dateExpirationPermisConduire: "12/12/2020",
    numeroPasseport: "1234567890",
    dateDelivrancePasseport: "12/12/2010",
    lieuDelivrancePasseport: "Ariana",
    dateExpirationPasseport: "12/12/2020",
    numeroCarteSejour: "1234567890",
    dateDelivranceCarteSejour: "12/12/2010",
    lieuDelivranceCarteSejour: "Ariana",
    dateExpirationCarteSejour: "12/12/2020",
    numeroCarteIdentite: "1234567890",
    dateDelivranceCarteIdentite: "12/12/2010",
    lieuDelivranceCarteIdentite: "Ariana",
    dateExpirationCarteIdentite: "12/12/2020",
    numeroCarteElecteur: "1234567890",
    dateDelivranceCarteElecteur: "12/12/2010",
    lieuDelivranceCarteElecteur: "Ariana",
    dateExpirationCarteElecteur: "12/12/2020",
    numeroCarteConsulaire: "1234567890",
  },
  {
    nom: "Chelhi",
    prenom: "Nidhal",
...
const TableThree = () => {
  return (
    <div className="space-y-4 rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <SearchForm placeholder="Rechercher une personne physique" />
      ...
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          ...
          <tbody>
            {personnesPhysiquesData.map((personne, index) => (
